        ...
        <div className="container">
          <div className="header__content">
            ...
            <div className="header__hotline col-lg-3">
              <a href="#">
                <img src="../assets/images/header/mobile-phone.svg" />{" "}
                0869394765
              </a>
            </div>
            ...
            <div className="header__help col-lg-3">
              <ul>
                <li className="header__cart">
                  <Link to="/cart">
                    <img src="../assets/images/header/shopping-cart.svg" />
                  </Link>
                ...
                {isLogin &&
                  (<li className="header__account">
                    <a>
                      <img
                        src={`https://ui-avatars.com/api/?background=ff324d&color=fff&name=+${loginUser.lastName}`}
